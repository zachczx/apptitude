...
>
	...
	<div class="space-y-5 self-center text-xl lg:col-span-8">
		<h2>What's Apptitude?</h2>
		<p>
...
>
	<div class="space-y-5 self-center text-xl lg:col-span-8">
		...
		<p>
			I think of bad products as any combination of not solving any problems, slow, lousy features,
			expensive for little ROI.
		</p>
		<p>
...
>
	...
	<div class="space-y-5 self-center text-xl lg:col-span-8">
		...
		<p>Unfortunately there's no test for knowledge before people are put in positions of power.</p>
	</div>
</div>
<div
	class="mb-7 grid grid-cols-1 justify-items-center gap-x-8 gap-y-8 px-5 lg:grid-cols-12 lg:px-20"
...
>
	...
	<div class="space-y-5 self-center text-xl lg:col-span-8">
		...
		<ul class="ms-4 list-disc text-lg">
