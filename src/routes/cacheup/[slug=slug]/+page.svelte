		...
		{#each data.post.bylines as byline, index}
			...
			<div class="chat-image avatar">
			  <div class="w-14 rounded-full">
				<img src="/src/lib/assets/profileheads/{byline.icon ? byline.icon : 'user-circle.svg'}" alt="Author">
			</div>
			</div>
...
<div class="grid grid-cols-1 justify-items-center gap-x-8 gap-y-8 px-5 lg:px-20">
	<div class="collapse bg-base-200">
		...
		>
			...
			<h2 class="flex"><svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-description inline me-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M9 17h6" /><path d="M9 13h6" /></svg>Definitions</h2>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
		</div>
	...
	<div class="collapse bg-base-200">
		...
		>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
			<h2 class="flex"><svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-target-arrow inline me-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 7a5 5 0 1 0 5 5" /><path d="M13 3.055a9 9 0 1 0 7.941 7.945" /><path d="M15 6v3h3l3 -3h-3v-3z" /><path d="M15 9l-3 3" /></svg>Goals</h2>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
		</div>
	...
	<div class="collapse bg-base-200">
		...
		>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
			<h2 class="flex"><svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-progress-help inline me-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 16v.01" /><path d="M12 13a2 2 0 0 0 .914 -3.782a1.98 1.98 0 0 0 -2.414 .483" /><path d="M10 20.777a8.942 8.942 0 0 1 -2.48 -.969" /><path d="M14 3.223a9.003 9.003 0 0 1 0 17.554" /><path d="M4.579 17.093a8.961 8.961 0 0 1 -1.227 -2.592" /><path d="M3.124 10.5c.16 -.95 .468 -1.85 .9 -2.675l.169 -.305" /><path d="M6.907 4.579a8.954 8.954 0 0 1 3.093 -1.356" /></svg>Questions to answer</h2>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
		</div>
		<div class="collapse-content bg-gradient-to-b from-pink-800 to-rose-700">
			<div class="card w-full bg-base-300 px-5 shadow-xl">
	...
	<div class="collapse bg-base-200">
		...
		>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
			<h2 class="flex"><svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-map-star inline me-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9.718 17.359l-.718 -.359l-6 3v-13l6 -3l6 3l6 -3v7.5" /><path d="M9 4v13" /><path d="M15 7v4" /><path d="M17.8 20.817l-2.172 1.138a.392 .392 0 0 1 -.568 -.41l.415 -2.411l-1.757 -1.707a.389 .389 0 0 1 .217 -.665l2.428 -.352l1.086 -2.193a.392 .392 0 0 1 .702 0l1.086 2.193l2.428 .352a.39 .39 0 0 1 .217 .665l-1.757 1.707l.414 2.41a.39 .39 0 0 1 -.567 .411l-2.172 -1.138z" /></svg>Solutions and the way ahead</h2>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
		</div>
		<div class="collapse-content bg-gradient-to-b from-slate-900 to-slate-800">
			<div class="card w-full bg-base-300 px-5 shadow-xl">
	...
	<div class="collapse bg-base-200">
		...
		>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
			<h2 class="flex"><svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-message-2 inline me-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 9h8" /><path d="M8 13h6" /><path d="M9 18h-3a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-3l-3 3l-3 -3z" /></svg>Suggestions</h2>
			<div class="self-center"><img src={chevronDown} alt="Arrow down" /></div>
		</div>
		<div class="collapse-content bg-gradient-to-b from-slate-900 to-slate-800">
			<div class="card w-full bg-base-300 px-5 shadow-xl">
