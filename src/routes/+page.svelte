...
<div class="grid grid-cols-1 justify-items-center gap-x-8 gap-y-8 px-5 lg:grid-cols-2 lg:px-20">
	 <div class="avatar flex self-stretch lg:self-start px-12"><div class="rounded-full"><enhanced:img src={sgneopunk} alt="Dystopian Singapore" sizes="(min-width:1920px) 1428px, (min-width:1080px) 1080px, (min-width:768px) 400px"></div></div>
	<div class="grid justify-items-center content-start">
		<div class="ps-2 pe-4">
			...
			<p class="mb-7">I don't think any public servant wakes up and says "let me think of ways to waste money and make a bad product". If there is, fire that person! In my view, a lot of the time, decisions or policies made are head scratchers. Maybe because they were made by people who don't hear from the ones actually using or building these things. Or maybe they're unaware they're doing the wrong things despite best intentions, and then they get promoted.</p>
			<h2 class="mb-7">Apptitude is a good product then?</h2>
			<p class="mb-7">So I started writing Apptitude here and there, at nights and weekends.</p>
				<p class="mb-7">I hope this is a resource for my teammates to figure out for themselves:</p> 
				<ul class="list-decimal ms-7 mb-7 space-y-1">
					<li class="ps-3">What people who made successful products think a good product is</li>
					<li class="ps-3">Questions to keep at the back of my mind to expose bad products and decisions</li>
