...
<div class="grid grid-cols-5 px-2 py-5 lg:px-20">
	...
	<main class="col-span-3 w-full space-y-8 border-r-2 border-r-gray-700 bg-base-300">
		<nav class="grid w-full justify-items-start border-b-2 border-b-gray-700 py-4 ps-8">
			<NewCrumbs urlMiddle="guides" textMiddle={'Guides'} textCurrent="Product Plan 101" />
		</nav>
		<h1
		...
		<article
			...
			<section id="the-problem" class="contents-observer">
				...
				<GuideExample>
					{#snippet example()}
						<ul class="space-y-4">
							...
							<li>
								<CarbonCheckmarkFilled class="mb-1 me-2 inline text-success" />This results in
				...
				<GuideExample>
					{#snippet example()}
						<div>
							<CarbonCheckmarkFilled class="mb-1 me-2 inline text-success" />Revenue loss of $XXM
				...
				<GuideExample>
					{#snippet example()}
						<div>
							<CarbonCloseFilled class="mb-1 me-2 inline text-warning" />We do not have a system
			...
			<section id="the-research" class="contents-observer">
				...
				<ul class="ms-8 list-disc space-y-4">
					<li>
						<em>Use Numbers Over Descriptions</em>. Quantitative data aids objective
						decision-making.
					</li>
					<li>
					...
					<li>
						...
						civil service staff work, it takes good judgement to determine the right amount of
						details in your plan. Too little details gives people little confidence to decide,
						whereas too much distracts the decision-makers.
					</li>
				</ul>
			</section>
			<section id="measurable-outcomes-targets" class="contents-observer">
				...
				<GuideExample>
					{#snippet example()}
						<div>
							<CarbonCloseFilled class="mb-1 me-2 inline text-warning" />% of successful
							applications
				...
				<GuideExample>
					{#snippet example()}
						<div>
							<CarbonCloseFilled class="mb-1 me-2 inline text-warning" />% of applicants which
				...
				<GuideExample>
					{#snippet example()}
						<div>
							<CarbonCheckmarkFilled class="mb-1 me-2 inline text-success" />Cost per impact =
