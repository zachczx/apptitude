		...
		<div class="collapse collapse-arrow mb-10 bg-base-300">
			...
			<div class="collapse-content space-y-5 bg-base-300 px-5">
				...
				<p>
					...
					approval forums, meetings, daily standups, strategy brainstorming sessions, and even
					routine email proposals. My goal here is to give you the cheatsheets to give you the bare
					minimum heuristic tools to critique and make the products under your care better.
				</p>
