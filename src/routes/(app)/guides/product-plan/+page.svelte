		...
		<article
			...
			<section
				...
				<div class="col-span-3 mt-1">
					...
					<ul class="ms-8 mt-4 list-disc space-y-4">
						<li>
							Use Numbers Over Descriptions, because quantitative data aids objective
							decision-making.
						</li>
						<li>
						...
						<li>
							...
							service staff work, it takes good judgement to determine the right amount of details
			...
			<section id="the-problem" class="contents-observer grid grid-cols-4 gap-x-8 gap-y-16">
				...
				<ul class="col-span-3 ms-8 mt-1 list-disc space-y-4">
					...
					<li>
						Don't confuse the customer and the user. The customer (MOX) pays for the product, the
						user (business owners) interacts with the product.
					</li>
				</ul>
				...
				<ul class="col-span-3 ms-8 mt-1 list-disc space-y-4">
					<li>
						Based on data collected from users and speaking to them, state the user's
						characteristics, needs, and why they have that need.
					</li>
					<li>
				...
				<div class="col-span-3 mt-1">
					...
					<ul class="ms-8 mt-4 list-disc space-y-4">
						...
						<li>
							When first starting out, it is better to focus on a narrow problem statement,
							affecting a narrow set of users. Once you have solved that problem, you can expand out
							to other related problem statements and/or other similar users.
						</li>
						<li>
						...
						<ul class="ms-8 list-disc space-y-4">
							<li>
								Rather, consider what problem the existing system was solving and think about how
								you can better solve that when rebuilding it.
							</li>
							<li>
				...
				<div class="col-span-3 mt-1">
					...
					<ul class="ms-8 mt-4 list-disc space-y-4">
						<li>
							Being very aspirational when crafting a problem statement can prevent us from
			...
			<section
				...
				<div class="col-span-3 mt-1">
					<p>
						Generally, when setting targets, it is useful to consider what the cost per impact of
						the product will be.
					</p>
					<GuideExample>
						{#snippet example()}
			...
			<section id="risks" class="contents-observer grid grid-cols-4 gap-x-8 gap-y-16">
				...
				<div class="col-span-3 mt-1">
					<p>
						Risk mitigation is important so we can be confident in delivering an effective product
						on time. At each point throughout the life of your product, it is useful to think about
						the risks that have been mitigated and those which remain to be mitigated through future
						action.
					</p>
					<p class="mt-4">Broadly, there are three types of risk:</p>
					<ul class="ms-8 mt-4 list-disc space-y-4">
						<li>
							Market risk - the product will not be used, or even if it is used, it will not solve
							the identified problem.
						</li>
						<li>
							Technical risk - the solution cannot be built within the time and resource
							constraints.
						</li>
						<li>
				...
				<div class="col-span-3 mt-1">
					...
					<ul class="ms-8 mt-4 list-disc space-y-4">
						...
						<li>
							Low-risk assumptions are ones over which we have a high degree of control or where
							past data has proven that we are unlikely to be wrong.
						</li>
						<li>
							High-risk assumptions are ones that we have minimal control or will fundamentally
							change our direction if proven wrong.
						</li>
					</ul>
					<GuideExample>
						{#snippet example()}
					...
					<ul class="ms-8 mt-4 list-disc space-y-4">
						<li>
							Focus on the higher risk assumptions and find ways to validate if they were true
							(i.e., proofs-of-concept).
						</li>
						<li>
			...
			<section
				...
				<ul class="col-span-3 ms-8 mt-1 list-disc space-y-4">
					...
					<li>
						State of the Business: Where things currently stand, e.g., hard numbers, market
						standing, or any other pertinent details.
					</li>
					<li>
