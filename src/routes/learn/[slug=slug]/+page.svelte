...
<div
	class="mx-1 grid grid-cols-1 place-content-start gap-4 rounded-lg bg-base-300 px-2 py-5 shadow-xl lg:mx-7 lg:grid-cols-2 lg:px-5"
>
	...
	<div class="col-span-1 rounded-lg bg-base-200 p-5 lg:col-span-2">
		...
		<div class="grid">
			<h4 class="mb-3">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="icon icon-tabler icon-tabler-link inline"
					width="20"
					height="20"
					viewBox="0 0 24 24"
					stroke-width="1.5"
