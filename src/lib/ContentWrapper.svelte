...
<div class="mb-8 mt-8 grid grid-cols-5 px-2 py-5 lg:px-20">
	<aside
		...
		<h3 class="view-transition-menu-text w-full border-b-2 border-b-gray-700 px-8 py-4 text-xl">
			Menu
		</h3>
	...
	<aside class="col-span-1 hidden w-full content-start rounded-r-3xl lg:grid lg:bg-base-300">
		<h3 class="view-transition-thispost-text w-full border-b-2 border-b-gray-700 px-8 py-4 text-xl">
			This Post
		</h3>
